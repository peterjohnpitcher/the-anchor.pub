              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li className="pt-2">
                  <div className="flex gap-4">
                    <a href="https://www.facebook.com/theanchorpubsm/" className="hover:text-anchor-gold">
                      Facebook
                    </a>
                    <a href="https://www.instagram.com/theanchor.pub/" className="hover:text-anchor-gold">
                      Instagram
                    </a>
                  </div>
                </li>
