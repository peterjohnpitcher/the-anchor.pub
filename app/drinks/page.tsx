...
export default function DrinksMenuPage() {
  return (
    <>
      ...
      {/* Draught Beers & Ales */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-amber-50 to-amber-100/50 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Birra Moretti</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">4.6% ABV</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Carling</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">4.0% ABV</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Guinness</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">4.2% ABV</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Stella Artois</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">4.8% ABV</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Inch's Apple Cider</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">4.5% ABV</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Fosters</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">4.0% ABV</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Pravha</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">4.0% ABV</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-amber-400 hover:scale-[1.02]">
                <h3 className="font-bold text-xl text-amber-900 mb-2">Carlsberg</h3>
                <p className="text-sm font-semibold text-amber-600 mb-2">3.8% ABV</p>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-bl from-stone-50 to-stone-100/60 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-[0.03]">
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 2px 2px, rgba(120, 113, 108, 0.15) 1px, transparent 1px)`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <h3 className="text-2xl font-bold text-stone-900 mb-4">Bottled Ales</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                <h4 className="font-bold text-xl text-stone-900 mb-2">Abbot Ale</h4>
                <p className="text-sm font-semibold text-stone-600 mb-2">5.0% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Greene King IPA</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">3.6% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Old Speckled Hen</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">5.2% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Newcastle Brown Ale</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">4.7% ABV</p>
              ...
              <h3 className="text-2xl font-bold text-stone-900 mb-4">Bottled Beers</h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Budweiser</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">5.0% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Corona Extra</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">4.5% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Desperados</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">5.9% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Peroni</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">5.1% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Peroni 0%</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">0.0% ABV</p>
              ...
              <h3 className="text-2xl font-bold text-stone-900 mb-4">Bottled Ciders</h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Magners</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">4.5% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Old Mout Berries & Cherries</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">4.0% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Old Mout Kiwi & Lime</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">4.0% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Old Mout Strawberry & Apple</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">4.0% ABV</p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-stone-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-stone-900 mb-2">Aspall</h4>
                  <p className="text-sm font-semibold text-stone-600 mb-2">5.5% ABV</p>
      ...
      {/* Cocktails */}
      <section className="py-16 md:py-20 bg-gradient-to-tr from-pink-50 to-pink-100/40 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-[0.04]">
          <div className="absolute inset-0" style={{
            backgroundImage: `repeating-linear-gradient(-45deg, transparent, transparent 20px, rgba(236, 72, 153, 0.1) 20px, rgba(236, 72, 153, 0.1) 40px)`
          }}></div>
        </div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-pink-900 mb-8 text-center">
              🍹 Cocktails
            </h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Aperol Spritz</h4>
                  <p className="text-gray-700 text-sm">Aperol, prosecco, soda water. Light, refreshing Italian classic.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Espresso Martini</h4>
                  <p className="text-gray-700 text-sm">Vodka, coffee liqueur, fresh espresso. The perfect pick-me-up.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Passion Fruit Martini</h4>
                  <p className="text-gray-700 text-sm">Vodka, passoa, passion fruit, lime. Served with prosecco shot.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Classic Margarita</h4>
                  <p className="text-gray-700 text-sm">Tequila, triple sec, lime juice. Salt or sugar rim optional.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Vodka Margarita</h4>
                  <p className="text-gray-700 text-sm">Our twist on the classic. Vodka, triple sec, lime juice.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Sex on the Beach</h4>
                  <p className="text-gray-700 text-sm">Vodka, peach schnapps, orange and cranberry juice.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Woo Woo</h4>
                  <p className="text-gray-700 text-sm">Vodka, peach schnapps, cranberry juice. Simple and delicious.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Pimms</h4>
                  <p className="text-gray-700 text-sm">Pimm's No.1, lemonade, fresh fruit and mint. Summer in a glass.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Margarita Spritz</h4>
                  <p className="text-gray-700 text-sm">Tequila, triple sec, prosecco. A bubbly twist on the classic.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Apple and Blackberry Pie</h4>
                  <p className="text-gray-700 text-sm">Vodka, apple juice, blackberry liqueur. Autumn comfort in a glass.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Crimbo Colada</h4>
                  <p className="text-gray-700 text-sm">Festive twist on piña colada. Rum, coconut, cranberry.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Bailey's Hot Chocolate</h4>
                  <p className="text-gray-700 text-sm">Rich hot chocolate with Baileys. Topped with whipped cream.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Hot Toddy</h4>
                  <p className="text-gray-700 text-sm">Whisky, honey, lemon, hot water. Winter warmer.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Baby Guinness</h4>
                  <p className="text-gray-700 text-sm">Kahlúa and Baileys layered shot. Looks like a mini pint.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Jager Bomb</h4>
                  <p className="text-gray-700 text-sm">Jägermeister dropped in Red Bull. Party starter.</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-pink-400 hover:scale-[1.02]">
                  <h4 className="font-bold text-xl text-pink-900 mb-2">Kick Bomb</h4>
      ...
      {/* Spirits */}
      <section className="py-16 md:py-20 bg-gradient-to-bl from-blue-50 to-blue-100/40 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-[0.03]">
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 20px 20px, rgba(59, 130, 246, 0.08) 2px, transparent 2px), radial-gradient(circle at 60px 60px, rgba(59, 130, 246, 0.08) 2px, transparent 2px)`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-8 text-center">
              ...
              {/* Gin Selection */}
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 mb-8 shadow-md border border-blue-100">
                <h3 className="text-2xl font-bold text-blue-900 mb-6 text-center">Gin Collection</h3>
                <p className="text-center text-blue-700 mb-8">All served with premium tonic and garnish</p>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-blue-50/50 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <h4 className="font-bold text-xl text-blue-900 mb-2">Bombay Sapphire</h4>
                    <p className="text-gray-700 text-sm">Aromatic with bright citrus notes. Ten hand-selected botanicals from around the world.</p>
                  </div>
                  <div className="bg-blue-50/50 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <h4 className="font-bold text-xl text-blue-900 mb-2">Gordons</h4>
              ...
              {/* Tequila Selection */}
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 mb-8 shadow-md border border-blue-100">
                <h3 className="text-2xl font-bold text-blue-900 mb-6 text-center">Tequila & Mezcal</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Jose Cuervo Gold</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Jose Cuervo Silver</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Cazcabel Coffee</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Patron Silver</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Olmeca Altos Plata</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Olmeca Reposado</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Vida Mezcal</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Lustre Strawberry Cream</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50/50 rounded-lg hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-blue-400 hover:scale-[1.02]">
                    <p className="font-semibold text-blue-900">Lustre Pineapple Cream</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-md border border-blue-100">
                  <h3 className="font-bold text-xl text-blue-900 mb-4">Vodka</h3>
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-md border border-blue-100">
                  <h3 className="font-bold text-xl text-blue-900 mb-4">Rum</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li>Bacardi</li>
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-md border border-blue-100">
                  <h3 className="font-bold text-xl text-blue-900 mb-4">Liqueurs & Shooters</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li>Aperol</li>
                    <li>Archers</li>
                    <li>Cointreau</li>
      ...
      {/* Wines */}
      <section className="py-16 md:py-20 bg-gradient-to-tl from-purple-50 to-purple-100/40 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-[0.03]">
          <div className="absolute inset-0" style={{
            backgroundImage: `linear-gradient(45deg, transparent 25%, rgba(147, 51, 234, 0.05) 25%, rgba(147, 51, 234, 0.05) 50%, transparent 50%, transparent 75%, rgba(147, 51, 234, 0.05) 75%)`,
          ...
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-8 text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-purple-400 hover:scale-[1.02]">
                  <h3 className="font-bold text-xl text-purple-900 mb-4">Red Wines</h3>
                  <ul className="space-y-2 text-gray-700">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-purple-400 hover:scale-[1.02]">
                  <h3 className="font-bold text-xl text-purple-900 mb-4">White Wines</h3>
                  <ul className="space-y-2 text-gray-700">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-purple-400 hover:scale-[1.02]">
                  <h3 className="font-bold text-xl text-purple-900 mb-4">Rosé & Sparkling</h3>
                  <ul className="space-y-2 text-gray-700">
              ...
              <p className="text-center mt-6 text-purple-700 italic">
      ...
      {/* Soft Drinks & Mixers */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-green-50 to-green-100/40 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-[0.03]">
          <div className="absolute inset-0" style={{
          ...
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-green-900 mb-8 text-center">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-green-400 hover:scale-[1.02]">
                  <h3 className="font-bold text-xl text-green-900 mb-4">Soft Drinks</h3>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-green-400 hover:scale-[1.02]">
                  <h3 className="font-bold text-xl text-green-900 mb-4">Mixers</h3>
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>Coca Cola</div>
                    <div>Diet Coke</div>
                    <div>Coke Zero</div>
      ...
      {/* Hot Drinks */}
      <section className="py-16 md:py-20 bg-gradient-to-tr from-orange-50 to-orange-100/40 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-[0.04]">
          <div className="absolute inset-0" style={{
            backgroundImage: `repeating-conic-gradient(from 0deg at 50% 50%, transparent 0deg, rgba(251, 146, 60, 0.05) 20deg, transparent 40deg)`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-orange-900 mb-8 text-center">
              ...
              <div className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-orange-400 hover:scale-[1.02] max-w-2xl mx-auto">
                <p className="text-center text-orange-700 mb-6 font-medium">
                  Available with cold milk, sugar, or sweetener
                </p>
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div className="py-2 px-4 bg-orange-50 rounded-lg text-orange-900 font-medium">Americano</div>
                  <div className="py-2 px-4 bg-orange-50 rounded-lg text-orange-900 font-medium">Cappuccino</div>
                  <div className="py-2 px-4 bg-orange-50 rounded-lg text-orange-900 font-medium">Latte</div>
                  <div className="py-2 px-4 bg-orange-50 rounded-lg text-orange-900 font-medium">Espresso</div>
                  <div className="py-2 px-4 bg-orange-50 rounded-lg text-orange-900 font-medium">Hot Chocolate</div>
                  <div className="py-2 px-4 bg-orange-50 rounded-lg text-orange-900 font-medium">Tea (various)</div>
                </div>
              </div>
            </div>
          </div>
