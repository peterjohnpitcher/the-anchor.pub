...
export function generateFallbackSEOContent(tag: string): TagSEOContent {
  ...
  return {
    ...
    heroContent: `Welcome to our ${name.toLowerCase()} page at The Anchor, Stanwell Moor's favorite local pub. Explore our latest posts and updates about ${name.toLowerCase()}.`,
...
export const tagSEOContent: Record<string, TagSEOContent> = {
  ...
  'drinks': {
    ...
    valueProposition: 'Discover why The Anchor is Stanwell Moor\'s favorite drinking destination. With regular tasting events, seasonal specials, and the warmest welcome near Heathrow, your perfect pint is always waiting.',
  ...
  'food': {
    ...
    heroContent: 'Savor exceptional pub food at The Anchor Stanwell Moor, where traditional favorites meet modern culinary excellence. Our chefs use fresh, locally-sourced ingredients to create memorable dining experiences.',
    ...
    valueProposition: 'Whether you\'re joining us for a quick lunch, romantic dinner, or Sunday family gathering, The Anchor delivers exceptional food in a warm, welcoming atmosphere. Book your table today and taste why we\'re Stanwell Moor\'s favorite dining destination.',
  ...
  'community': {
    ...
    metaDescription: 'The Anchor: Stanwell Moor\'s community hub. Supporting local initiatives, hosting village events & bringing neighbors together. Your true local near Heathrow.',
    ...
    introContent: 'Deep roots in Stanwell Moor make The Anchor a true community pub. We actively support local charities, host village events, and provide a welcoming space for neighbors to connect. From quiz teams to book clubs, charity fundraisers to community meetings, we\'re proud to be part of the fabric of village life. Our commitment to the community extends beyond our doors - we source from local suppliers, employ local staff, and reinvest in making Stanwell Moor an even better place to live.',
  ...
  'live-music': {
    ...
    introContent: 'Music is at the heart of The Anchor\'s entertainment offering. Our carefully curated live music program features local talent and touring acts across all genres - rock, pop, jazz, blues, and acoustic sets. The intimate atmosphere of our venue means you\'re never far from the action, creating memorable nights for music lovers.',
    valueProposition: 'Check our events calendar for upcoming performances and book your table for dinner and a show. With great acoustics, a friendly crowd, and the best atmosphere near Heathrow, The Anchor is your destination for live music.',
  ...
  'stanwell-moor': {
    ...
    metaDescription: 'The Anchor: Stanwell Moor\'s beloved village pub. Traditional atmosphere, community hub, local favorite. Your true local in the heart of TW19.',
    heroContent: 'The Anchor has been at the heart of Stanwell Moor village for generations, serving as the community\'s favorite gathering place and true local pub.',
    ...
    valueProposition: 'Whether you\'re a long-time resident or new to Stanwell Moor, you\'ll find a warm welcome at The Anchor. Join us and discover why we\'ve been the village\'s favorite pub for generations.',
  ...
  'pizza': {
    ...
    description: 'Authentic stone-baked pizzas and Italian favorites',
  ...
  'tasting-events': {
    ...
    heroContent: 'Elevate your palate at The Anchor\'s exclusive tasting events. From fine wines to premium spirits, discover new favorites in Stanwell Moor.',
  ...
  'family-friendly': {
    ...
    heroContent: 'The Anchor welcomes families with open arms. From our dedicated kids menu to family events, we\'re Stanwell Moor\'s favorite family-friendly pub.',
    introContent: 'We believe pubs should be places where families create memories together. The Anchor offers everything you need for a stress-free family meal - a dedicated children\'s menu with healthy options, high chairs and booster seats, coloring activities to keep little ones entertained, and a spacious beer garden perfect for summer days. Our staff are experienced in making families feel welcome and comfortable.',
  ...
  'news': {
    ...
    introContent: 'The Anchor is always evolving to serve our community better. Our news section keeps you updated on menu changes and new dishes, upcoming events and entertainment, pub improvements and renovations, community initiatives and charity work, and important announcements. We believe in keeping our customers informed about everything happening at their favorite local pub.',
  ...
  'cocktails': {
    ...
    valueProposition: 'Elevate your evening with cocktails at The Anchor. Discover your new favorite cocktail - expertly mixed and beautifully presented.',
  ...
  'day-of-the-dead': {
    ...
    heroContent: 'Experience the color and culture of Día de los Muertos at The Anchor, where Mexican traditions come alive in a spectacular celebration of life and memory.',
    introContent: 'The Anchor transforms for Day of the Dead with vibrant decorations, traditional altars, and a festive atmosphere that honors this beautiful Mexican tradition. Our special menu features authentic Mexican dishes and drinks, including specialty tequilas and mezcals. Face painting, traditional music, and themed entertainment create an immersive cultural experience that\'s become one of Stanwell Moor\'s most anticipated annual events.',
  ...
  'environment': {
    ...
    introContent: 'Our commitment to the environment shapes everything we do at The Anchor. From sourcing ingredients locally to reduce food miles, to comprehensive recycling and waste reduction programs, we\'re constantly finding ways to minimize our environmental impact. Our beer garden features native plants that support local wildlife, while energy-efficient systems throughout the pub reduce our carbon footprint.',
  ...
  'festive-menu': {
    ...
    heroContent: 'Indulge in our spectacular festive menu at The Anchor, where traditional favorites meet creative seasonal dishes in a celebration of flavor.',
  ...
  'family-dining': {
    ...
    introContent: 'Family dining at The Anchor is designed to be stress-free and enjoyable for all ages. Our children\'s menu offers healthy, tasty options alongside kid favorites, all at family-friendly prices. High chairs, coloring materials, and patient staff ensure parents can relax while children are entertained. Our spacious layout provides room for pushchairs, and our beer garden offers safe outdoor space for little ones to explore.',
  ...
  'mexican': {
    ...
    heroContent: 'Spice up your dining at The Anchor with our Mexican offerings - from sizzling fajitas to premium tequilas, we bring Mexican flavors to Stanwell Moor.',
  ...
  'seasonal': {
    ...
    metaDescription: 'Discover seasonal offerings at The Anchor Stanwell Moor. Seasonal menus, drinks, events throughout the year. Fresh flavors near Heathrow.',
    ...
    valueProposition: 'Experience The Anchor in every season - each visit brings new flavors, fresh experiences, and reasons to celebrate the time of year.',
  ...
  'womens-day': {
    ...
    introContent: 'International Women\'s Day sees The Anchor hosting special celebrations honoring women\'s achievements and contributions. From featuring women-owned suppliers and breweries to hosting inspirational speakers and networking events, we create spaces for celebration and connection. Our regular ladies\' nights and women-focused events throughout the year continue this commitment to inclusivity and recognition.',
  ...
  'celebration': {
    ...
    introContent: 'The Anchor has been the backdrop for countless celebrations - birthdays that span generations, anniversaries marked with champagne toasts, achievements honored among friends, and life\'s milestones celebrated in style. Our team excels at making every celebration special, whether it\'s an intimate gathering or a large party. We handle the details so you can focus on enjoying your special moment.',
  ...
  'local-area': {
    ...
    metaTitle: 'Local Area Guide Stanwell Moor | The Anchor\'s Neighborhood',
